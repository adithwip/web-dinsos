...
class DataRekapPMKSChart extends React.Component {
  state = {
    dataP3S: null,
    error: false,
    loading: false,
  ...
  render() {
    ...
    return (
      <ChartCard title="Data Rekap Penertiban / Penjangkauan PMKS" to="data/data-petugas-p3s">
        <Grid
          style={{ height: "100%" }}
          container
          direction="column"
...
export default DataRekapPMKSChart